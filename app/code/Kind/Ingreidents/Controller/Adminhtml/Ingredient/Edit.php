...
class Edit extends \Kind\Ingreidents\Controller\Adminhtml\Ingredient
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('kind_ingreidents_ingredient', $model);
        ...
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? $model->getTitle() : __('New Ingredient'));
        return $resultPage;
    }
}
